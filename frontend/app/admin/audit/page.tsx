      ...
      <main className="flex-1 pb-32 max-w-6xl mx-auto w-full p-4 md:p-8">
        ...
        {isLoading ? (
          <div className="space-y-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 animate-pulse">
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="md:w-64 space-y-4">
                    <div className="h-2 w-20 bg-slate-100 dark:bg-slate-800 rounded"></div>
                    <div className="flex items-center gap-3">
                      <div className="size-10 rounded-full bg-slate-100 dark:bg-slate-800"></div>
                      <div className="space-y-2">
                        <div className="h-3 w-20 bg-slate-100 dark:bg-slate-800 rounded"></div>
                        <div className="h-2 w-32 bg-slate-50 dark:bg-slate-800/50 rounded"></div>
                      </div>
                    </div>
                  </div>
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="h-20 bg-slate-50 dark:bg-slate-800/50 rounded-2xl"></div>
                  </div>
                </div>
              </div>
            ))}
