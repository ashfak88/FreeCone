    ...
    <section className="py-16 px-4">
      <div className="max-w-6xl mx-auto bg-primary rounded-[2rem] p-8 md:p-16 relative overflow-hidden text-center text-white shadow-2xl shadow-primary/20">
        <div className="relative z-10">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">Join the world's most exclusive network of high-caliber freelancers and visionary entrepreneurs today.</p>
